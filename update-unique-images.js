...
async function updateWithUniqueImages() {
    try {
        ...
        // Completely unique images for each property
        const uniqueImages = [
        ...
        for (let i = 0; i < listings.length; i++) {
            ...
            // Each property gets a unique image
            listing.image = uniqueImages[i % uniqueImages.length];
            await listing.save();
            console.log(`Updated: ${listing.title} -> Image ${i + 1}`);
        }

        console.log("All properties updated with unique images!");
